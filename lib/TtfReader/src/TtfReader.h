...
//
// Supported: plain TrueType outlines (sfnt 0x00010000 / 'true'), cmap format 4
// and 12, simple glyphs, compound glyphs (ARGS_ARE_XY_VALUES), hhea/hmtx
// metrics. Explicitly rejected: OTTO/CFF, ttcf collections, WOFF/WOFF2,
// variable fonts (gvar/fvar presence), cmap formats other than 4/12.
